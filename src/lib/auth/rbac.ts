...
export const PERMISSIONS = {
  ...
  FINANCE_VIEW: "finance:view", // self-service: a parent/student viewing their own fee/invoice history

  INVENTORY_VIEW: "inventory:view",
  INVENTORY_MANAGE: "inventory:manage",

  HR_VIEW: "hr:view", // self-service: a teacher viewing their own leave/salary/documents
  HR_MANAGE: "hr:manage",

  MAINTENANCE_VIEW: "maintenance:view", // any staff member can raise/view their own tickets
  MAINTENANCE_MANAGE: "maintenance:manage", // assign technicians, change status, resolve
...
export const ROUTE_PERMISSIONS: { prefix: string; permission: Permission | Permission[] }[] = [
  ...
  { prefix: "/dashboard/accounts", permission: [PERMISSIONS.ACCOUNTS_MANAGE, PERMISSIONS.FINANCE_VIEW] },
  { prefix: "/dashboard/inventory", permission: [PERMISSIONS.INVENTORY_VIEW, PERMISSIONS.INVENTORY_MANAGE] },
  { prefix: "/dashboard/hr", permission: [PERMISSIONS.HR_VIEW, PERMISSIONS.HR_MANAGE] },
  { prefix: "/dashboard/maintenance", permission: [PERMISSIONS.MAINTENANCE_VIEW, PERMISSIONS.MAINTENANCE_MANAGE] },
  { prefix: "/dashboard/events", permission: [PERMISSIONS.EVENTS_VIEW, PERMISSIONS.EVENTS_MANAGE] },
